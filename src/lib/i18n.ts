...
const dictionaries = {
  nl: {
    ...
    settings: {
      title: "Instellingen",
      description: "Bewerk je naam en kies een avatar.",
      profilePreview: "Profielvoorbeeld",
      pickAvatar: "Kies een leuke dierenavatar met kleurachtergrond.",
      nameLabel: "Naam",
      namePlaceholder: "Jouw naam",
      avatarLabel: "Profielfoto",
      save: "Opslaan",
      saving: "Opslaan...",
  ...
  en_us: {
    ...
    settings: {
      title: "Settings",
      description: "Update your name and choose an avatar.",
      profilePreview: "Profile preview",
      pickAvatar: "Pick a cute animal avatar with a vibrant background.",
      nameLabel: "Name",
